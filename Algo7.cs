    ...
    public class OrderedList<T> 
    {
        ...
        public void Add(T value)
        {
            ...
            else
            {
                ...
                if (_ascending == true)//если нисходящие
                {
                    while (node != null)
                    {
                        ...
                        if (status == 1)
                        {
                            ...
                            int statusNext = Compare(value, node.next.value);
                            if (statusNext == -1)
                            {
                                InsertAfter(node, _item);
                                break;
                ...
                else if (_ascending == false)//если восходящий
                {
                    while (node != null)
                    {
                        int status = Compare(value, node.value);
        ...
        public void InsertAfter(Node<T> _nodeAfter, Node<T> _nodeToInsert)
        {
            ...
            else
            {
                ...
                foreach (Node <T> identifier in nodes)
                {
                    ...
                    int status = Compare(identifier.value, _nodeAfter.value);
                    if (status == 0)
                    {
